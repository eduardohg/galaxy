...
# program['radius']   = np.random.uniform(10,20,n)
program['position'] = [[ 0.60366566, 0.1759843, -0.29359368],
 [ 0.06542798,  0.14023681, -0.34067409],
 [ 0.17644865, -0.49165767, -0.31372221]]
program['radius'] = [15.84143294, 14.70174864, 19.40926073]


program['fg_color'] = 0,0,0,1
colors = np.random.uniform(0, 0.70, (n, 4))
colors[:,3] = 1
